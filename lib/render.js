...
function run(filePath, options) {
  ...
  var globals = shader.context;
  var cols, rows, fps, intervalMs, buffer, startTime, timer, stopTimer, stopped, frameCount;
  ...
  timer = setInterval(function () {
    ...
    globals.width = cols;
    globals.height = rows;
    globals.time = (Date.now() - startTime) / 1000;
    globals.frame = frameCount;
